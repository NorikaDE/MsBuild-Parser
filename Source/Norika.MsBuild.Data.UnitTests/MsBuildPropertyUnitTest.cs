...
namespace Norika.MsBuild.Data.UnitTests
{
    ...
    public class MsBuildPropertyUnitTest
    {
        ...
        [TestMethod]
        public void
            IsPropertyPublicSettable_WithConditionCheckingSomeOtherPropertiesAndNoPropertyValueTakeOverInContent_ShouldReturnFalse()
        {
            string propertyName = "TestProperty";
        ...
        [TestMethod]
        public void
            IsPropertyPublicSettable_WithCheckForPropertyIsNotEmptyInConditionAndTakeOverPropertyValueInAdditionalContent_ShouldReturnTrue()
        {
            string propertyName = "TestProperty";
            string propertyCondition = "$(TestProperty) != ''";
        ...
        {
            MsBuildXmlPropertyImplementation property =
                new MsBuildXmlPropertyImplementation(
                    CreateFromString("<Property Condition=\"$(Property)==''\">Value</Property>"));
        ...
        public void Construct_PropertyWithTakeOverValue_ShouldInitializeWithIsSettableTrue()
        {
            MsBuildXmlPropertyImplementation property =
                new MsBuildXmlPropertyImplementation(
                    CreateFromString("<Property Condition=\"$(Property)!=''\">$(Property) Value</Property>"));
        ...
        {
            MsBuildXmlPropertyImplementation property =
                new MsBuildXmlPropertyImplementation(CreateFromString("<Property>$(Property)</Property>"));
