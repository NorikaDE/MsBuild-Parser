...
{
    [TestClass]
    public class RegexPropertyConditionSelfCheckIsNotEmptyTest
    {
        ...
        public void Match_WitConditionCheckingPropertyIsEmpty_ShouldMatch()
        {
            ...
            Assert.IsTrue(_sut.IsMatch(inputValue),
                "Checking the current property for not empty should match regular expression.");
        }
        ...
        public void Match_WitConditionCheckingPropertyIsEmptyButOneEqualityCompareOperandOnly_ShouldNotMatch()
        {
            ...
            Assert.IsFalse(_sut.IsMatch(inputValue),
                "Using one not equal operand only in check should not match regular expression.");
        }
        ...
        public void Match_WitConditionCheckingQuotedPropertyIsEmpty_ShouldMatch()
        {
            ...
            Assert.IsTrue(_sut.IsMatch(inputValue),
                "Checking the current property for not empty should match regular expression if the property is quoted.");
        }
        ...
        public void Match_WitConditionCheckingPropertyIsEmptyAndMissingLeadingQuote_ShouldNotMatch()
        {
            ...
            Assert.IsFalse(_sut.IsMatch(inputValue),
                "Checking the current property for not empty should not match if the property is not quoted correctly.");
        }
